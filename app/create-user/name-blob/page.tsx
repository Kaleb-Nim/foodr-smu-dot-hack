...
const suggestedNames = [
    "Excited", "Iconic", "Cute", "Happy", "Weird", "Spiky",
    "Awkward", "Spooky", "Cool", "Blob", "Tomato", "Ghost",
    "Sassy", "Weird", "Flower"
];
        ...
        if (flow === 'join') {
            ...
            try {
                const response = await fetch("/api/groups/join", {
                    ...
                    body: JSON.stringify({ code: groupCode, userName: blobName, blobIcon }),
                });
            ...
            try {
                const response = await fetch("/api/groups/create", {
                    ...
                    body: JSON.stringify({ userName: blobName, groupName: storedGroupName, blobIcon }),
                });
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col">
            <header className="flex items-center p-4 bg-white shadow-sm">
                ...
                <h1 className="text-xl font-semibold ml-4">Name your Snackr</h1>
            </header>

            <div className="flex-grow p-4 flex flex-col items-center justify-center">
                {blobIcon && (
                    <Image src={blobIcon} alt="Selected Blob" width={150} height={150} className="mb-4" objectFit="contain" />
                )}
            ...
            <div className="p-4 bg-white border-t shadow-lg">
                ...
                <button
                    ...
                    className={`w-full py-3 rounded-md text-lg font-semibold transition-colors ${
                        (blobName && blobIcon) ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-gray-300 text-gray-500 cursor-not-allowed"
                    }`}
                >
